...
-- if you want to stat digging into AWR. You don't have to know att the tables
pause
...
@awr_top_by_sqlid_snaps.sql 24 50 5 40
set echo on
pause

@awr_top_by_sqlid_snaps.sql 24 50 7 10
set echo on
pause

@awr_top_by_sqlid_snaps.sql 24 50 12 10
set echo on
pause
